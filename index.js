...
const main = async () => {
    ...
    setInterval (function () {
      operations.process(clientOne, process.env.ServerID, process.env.DroleID, process.env.IroleID, BotData[0], BotData[1], BotData[2])
    }, 5*60000);
  });
  ...
  clientTwo.on('ready', async () => {
    ...
    setInterval (function () {
    operations.process(clientTwo, process.env.ServerID, process.env.DroleID, process.env.IroleID, BotData[0], BotData[1], BotData[2])
    }, 5*60000);
  });
  ...
  clientThree.on('ready', async () => {
    ...
    setInterval (function () {
    operations.process(clientThree, process.env.ServerID, process.env.DroleID, process.env.IroleID, BotData[0], BotData[1], BotData[2])
    }, 5*60000);
  });
  ...
  clientFour.on('ready', async () => {
    ...
    setInterval (function () { 
    operations.process(clientFour, process.env.ServerID, process.env.DroleID, process.env.IroleID, BotData[0], BotData[1], BotData[2])
    }, 5*60000);
  });
